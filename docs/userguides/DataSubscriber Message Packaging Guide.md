...
DishtaYantra v1.2.0 introduces **automatic packaging of non-dictionary messages** in the DataSubscriber class. This enhancement ensures consistent data format for downstream calculators regardless of the original message format from external sources like Kafka, RabbitMQ, REST APIs, and other message brokers.
...
The non-dictionary message packaging feature in DishtaYantra v1.2.0 provides:
