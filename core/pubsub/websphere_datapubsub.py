...
# v2.2 module split: the subscriber lives in websphere_subscriber.py.
from core.pubsub.websphere_subscriber import WebSphereMQDataSubscriber  # noqa: E402,F401
