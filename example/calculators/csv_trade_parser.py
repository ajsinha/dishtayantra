...
This calculator demonstrates how to handle the v1.2.0 auto-packaged
...
class CSVTradeParserCalculator:
    ...
    def calculate(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Check if this is a packaged message (v1.2.0 feature)
...
if __name__ == '__main__':
    ...
    # Test 1: Packaged CSV string (v1.2.0 format)
    packaged_input = {
        'payload': "TRADE_001,BUY,100,AAPL,150.25",
        '_packaged': True,
        '_original_type': 'str',
